...
class LRUCache(BaseCaching):
    """
    A caching system that uses the LRU algorithm to manage the cache.
    """
    ...
    def put(self, key, item):
        ...
        BaseCaching.MAX_ITEMS: you must discard the least recently used item
        (LRU algorithm) and print DISCARD: with the key discarded and
